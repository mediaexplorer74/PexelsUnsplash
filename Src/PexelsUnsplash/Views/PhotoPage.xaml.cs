...
namespace Stream.Wall.Views {
    public sealed partial class PhotoPage : Page {
        ...
        public static Unsplasharp.Models.Photo _CurrentPhoto { get; set; }

        private Image _CurrentPhotoImage { get; set; }

        private DataSource _PageDataSource { get; set; }

        private IList<Unsplasharp.Models.Photo> _PageItemsSource { get; set; }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e) {
            ...
            if (e.NavigationMode != NavigationMode.Back) {
                _CurrentPhoto = (Unsplasharp.Models.Photo)parameters[0];
            }

            _PageItemsSource  = (IList<Unsplasharp.Models.Photo>)parameters[1];
        ...
        private async void CmdSetAsWallpaper(object sender, RoutedEventArgs e) {
        ...
        private async void CmdSetAsLockscreen(object sender, RoutedEventArgs e) {
        ...
        private void CmdToggleCaption_Tapped(object sender, RoutedEventArgs e) {
        ...
        private void CmdCrop_Tapped(object sender, RoutedEventArgs e) {
            
        }

        private void CmdStretch_Tapped(object sender, RoutedEventArgs e) {
        ...
        private void CmdAddToFavorites_Tapped(object sender, RoutedEventArgs e) {
        ...
        private void CmdRemoveFromFavorites_Tapped(object sender, RoutedEventArgs e) {
        ...
        private void PhotosFlipView_SelectionChanged(object sender, SelectionChangedEventArgs e) {
            _CurrentPhoto = (Unsplasharp.Models.Photo)PhotosFlipView.SelectedItem;
        ...
        private Grid GetCurrentItemTemplateRoot() {
            var photo = (Unsplasharp.Models.Photo)PhotosFlipView.SelectedItem;
        ...
        private void RefreshFavoritesCommands() {
            if (App.DataSource.LocalFavorites!= null && App.DataSource.LocalFavorites.Contains(_CurrentPhoto.Id)) {
        ...
        private void MergePhotoData(Unsplasharp.Models.Photo target, Unsplasharp.Models.Photo source) {
