...
namespace Stream.Wall.Views {
    public sealed partial class SettingsPage : Page {
        ...
        private void InitializeVariables() {
            ...
            var version = string.Format("version {0}", Settings.GetAppVersion());
        }
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            if (!string.IsNullOrEmpty(Key.Text))
            {
                ...
                settingsValues["access_key"] = Key.Text;
                var toastMessage = "your key successfully changed!, please reset this app...";
                Notify(toastMessage);
            }
        }
        ...
        private void SupportButton_Click(object sender, RoutedEventArgs e) {
            ...
            Windows.System.Launcher.LaunchUriAsync(new Uri("https://github.com/meysamhadeli/wallstream"));
        }
