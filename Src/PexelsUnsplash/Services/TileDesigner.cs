...
namespace Stream.Wall.Services {
    public class TileDesigner {
        ...
        private static TileNotification CreateNotification(Unsplasharp.Models.Photo photo) {
            var content = new TileContent() {
                Visual = new TileVisual() {
        ...
        private static TileBinding CreateBinding(Unsplasharp.Models.Photo photo) {
