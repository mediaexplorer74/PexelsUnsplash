...
namespace Stream.Wall.Services {
    public class Wallpaper {
        public static async Task<bool> SetAsWallpaper(Unsplasharp.Models.Photo photo, Action<HttpProgress> httpProgressCallback) {
            bool success = false;
        ...
        public static async Task<bool> SetAsLockscreen(Unsplasharp.Models.Photo photo, Action<HttpProgress> httpProgressCallback) {
            bool success = false;
        ...
        /// <returns></returns>
        public static async Task<bool> SaveToPicturesLibrary(Unsplasharp.Models.Photo photo, Action<HttpProgress> httpProgressCallback, string url = "") {
            StorageFile file;
        ...
        private static string ChooseBestPhotoFormat(Unsplasharp.Models.Photo photo) {
